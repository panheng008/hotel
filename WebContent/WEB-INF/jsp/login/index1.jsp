...
<section id="hero-action-section" class="hero-action-section">
		...
		<div class="container ow-section">
			...
			<p><a href="${ctx}/book_bookIndex.do" class="get-started">立刻预定!!</a></p>
		</div><!-- /.Container -->
	</section>
            ...
            <c:forEach items="${pagers.datas}" var="pic" varStatus="status">  
                <div class="portfolio-item designing">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="${pic.image}" alt="">
<!--                         <div class="portfolio-info"> 	 -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/01.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
                    </div>
                </div><!--/.portfolio-item-->
	        </c:forEach>
...
<!--                     <div class="portfolio-item-inner"> -->
<%--                         <img class="img-responsive" src="${ctx}/resource/images/portfolio/02.jpg" alt=""> --%>
<!--                         <div class="portfolio-info">  -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/02.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div>/.portfolio-item -->
...
<!--                 <div class="portfolio-item designing"> -->
<!--                     <div class="portfolio-item-inner"> -->
<%--                         <img class="img-responsive" src="${ctx}/resource/images/portfolio/03.jpg" alt=""> --%>
<!--                         <div class="portfolio-info">  -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/03.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div>/.portfolio-item -->
...
<!--                     <div class="portfolio-item-inner"> -->
<%--                         <img class="img-responsive" src="${ctx}/resource/images/portfolio/04.jpg" alt=""> --%>
<!--                         <div class="portfolio-info">  -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/04.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div>/.portfolio-item -->
...
<!--                     <div class="portfolio-item-inner"> -->
<%--                         <img class="img-responsive" src="${ctx}/resource/images/portfolio/05.jpg" alt=""> --%>
<!--                         <div class="portfolio-info">  -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/05.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div>/.portfolio-item -->
...
<!--                 <div class="portfolio-item mobile"> -->
<!--                     <div class="portfolio-item-inner"> -->
<%--                         <img class="img-responsive" src="${ctx}/resource/images/portfolio/06.jpg" alt=""> --%>
<!--                         <div class="portfolio-info">  -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/06.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div>/.portfolio-item -->
...
<!--                 <div class="portfolio-item designing development"> -->
<!--                     <div class="portfolio-item-inner"> -->
<%--                         <img class="img-responsive" src="${ctx}/resource/images/portfolio/07.jpg" alt=""> --%>
<!--                         <div class="portfolio-info">  -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/07.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div>/.portfolio-item -->
...
<!--                 <div class="portfolio-item mobile"> -->
<!--                     <div class="portfolio-item-inner"> -->
<%--                         <img class="img-responsive" src="${ctx}/resource/images/portfolio/08.jpg" alt=""> --%>
<!--                         <div class="portfolio-info">  -->
<%--                             <a class="preview" href="${ctx}/resource/images/portfolio/08.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a> --%>
<!--                         </div> -->
<!--                     </div> -->
<!--                 </div>/.portfolio-item -->
            </div>
...
<!--         <div class="container"> -->
<!--             <div class="section-header"> -->
<!--                 <h2 class="section-title wow fadeInDown">价位</h2> -->
<!--                 <p class="wow fadeInDown">我们提供多种价位的客房供您选择。</p> -->
<!--             </div> -->
...
<!--                                 </div> -->
<!--                             </li> -->
<!--                             <li><strong>1</strong> 人</li> -->
<!--                             <li><strong>20M</strong> 带宽</li> -->
<!--                             <li><strong>经济舒适</strong> 大床</li> -->
<!--                             <li>洗衣服务</li> -->
<!--                             <li><strong>24/7</strong> 服务</li> -->
<!--                             <li class="plan-purchase"><a class="btn btn-primary" href="#">立即预定!</a></li> -->
<!--                         </ul> -->
<!--                     </div> -->
<!--                 </div> -->
<!--                 <div class="col-md-3 col-sm-6 col-xs-12"> -->
...
<!--                                 </div> -->
<!--                             </li> -->
<!--                             <li><strong>2</strong> 人</li> -->
<!--                             <li><strong>20M</strong> 带宽</li> -->
<!--                             <li><strong>高级双人</strong> 大床</li> -->
<!--                             <li>洗衣服务</li> -->
<!--                             <li><strong>24/7</strong> 服务</li> -->
<!--                             <li class="plan-purchase"><a class="btn btn-primary" href="#">立即预定!</a></li> -->
<!--                         </ul> -->
...
<!--                                 </div> -->
<!--                             </li> -->
<!--                             <li><strong>6</strong> 人</li> -->
<!--                             <li><strong>50M</strong> 带宽</li> -->
<!--                             <li><strong>豪华舒适</strong> 大床</li> -->
<!--                             <li>洗衣服务</li> -->
<!--                             <li><strong>24/7</strong> 服务</li> -->
<!--                             <li class="plan-purchase"><a class="btn btn-primary" href="#">立即预定!</a></li> -->
<!--                         </ul> -->
...
<!--                                 </div> -->
<!--                             </li> -->
<!--                             <li><strong>8</strong> 人</li> -->
<!--                             <li><strong>100M</strong> 带宽</li> -->
<!--                             <li><strong>高级总统</strong> 大床</li> -->
<!--                             <li>洗衣服务</li> -->
<!--                             <li><strong>24/7</strong> 服务</li> -->
<!--                             <li class="plan-purchase"><a class="btn btn-primary" href="#">立即预定!</a></li> -->
<!--                         </ul> -->
