package com.hotel.base.dao.impl;
...
import com.hotel.utils.SystemContext;
...
public class BaseDaoImpl<T> implements BaseDao<T> {
	...
	public List<T> list(String hql, Object[] args, Map<String, Object> alias) {
		...
		setAliasParameter(query, alias);//别名
	...
	public Pager<T> find(String hql, Object[] args, Map<String, Object> alias) {
		...
		Query cquery = getSession().createQuery(cq);//查询所有用户的数据
		Query query = getSession().createQuery(hql);//30-45数据
		//设置别名参数
